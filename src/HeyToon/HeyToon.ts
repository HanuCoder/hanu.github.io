...
const SOURCE_DOMAIN = "https://heytoon.net/"

export class HeyToon extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'HeyToon' }
    get description(): string { return 'HeyToon has stuff' }
    get author(): string { return 'Hanu' }
